...
<template>
  <div class="w-full h-auto">
        ...
        <div class="grid grid-cols-5 gap-4">
          <div class="col-span-5 md:col-span-2">
            <div class="w-full max-w-sm m-auto mb-6 lg:mb-0">
              <img src="/img/demo-phone-e.png" alt="Finsell main screen" />
            </div>
          </div>
    ...
    <section class="bg-gray-200 bg-opacity-50 font-sans">
      <div
        class="container m-auto flex flex-col md:flex-row w-full px-8 md:px-16"
      >
        <div
          class="flex flex-col w-full lg:w-1/2 justify-center items-start py-8"
        >
          <label
            for="tagline"
        ...
        <div class="col-span-5 md:col-span-2">
          <div class="text-left">
            ...
            <p class="leading-tight mt-8 mb-4 max-w-xs mx-8 text-gray-600">
              ...
              plan that actually works. You can keep track of your expenses and
              incomes from your mobile phone. You'll never go over your budget
              or miss a payment again with
              <span class="font-semibold">finsell</span> you can do that on the
              go.
            </p>
          </div>
        </div>
          ...
          <div class="grid grid-cols-3 gap-3 my-8">
            ...
            >
              <div
                ...
                alt=""
              ></div>
              <h3 class="mt-6 mb-1 font-bold text-gray-800 leading-none">
              ...
              <p
                ...
                "
              >
                Personalized Mintsights™ make your money go further. We’ll
                automatically find savings you missed.
              </p>
            </div>
            <div
              class="
            ...
            >
              ...
              >
                ...
                going. Save for a home, crush debt, and prepare for the future.
              </p>
            </div>
            <div
              class="
            ...
            >
              ...
              <p
                ...
                "
              >
                See where all your money goes by easily adding your cash, credit
    ...
    <section class="font-sans text-center py-12 md:py-24 px-4 lg:px-0 bg-white">
      <div
        class="
          container
          flex flex-col
